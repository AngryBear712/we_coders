	...
	?>
        ...
        <div class="faq-search text-center pt-40">
            <h2 class="">Что ищем?</h2>
                    <form  class="mb-20" action="#" method="get">
                        ...
                        <table width="100%" >
                            <tbody><tr>
                                <td>
                                    ...
                                    <?else:?>
                                        <input class="search-query" type="text" name="q"  placeholder="Поиск" value="<?=$arResult["REQUEST"]["QUERY"]?>" />
                                    <?endif;?>
                                </td>
                                <td>
                                    <button class="search-button" type="submit" value="<?echo GetMessage("CT_BSP_GO")?>"><i class="fa fa-search"></i></button>
...
<?if(isset($arResult["REQUEST"]["ORIGINAL_QUERY"])):
	...
	<?elseif($arResult["ERROR_CODE"]!=0):?>
		...
		<br /><br />
		<p><?=GetMessage("11111111111")?><br /><b><?=GetMessage("CT_BSP_LOGIC")?></b></p>
